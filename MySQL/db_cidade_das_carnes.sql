...
insert tb_produtos (nome, preco, qtProduto, categoria_id) values ("Hamburguer",60.00,30,1);
...
insert tb_produtos (nome, preco, qtProduto, categoria_id) values ("Orelha de porco",20.00,30,2);
insert tb_produtos (nome, preco, qtProduto, categoria_id) values ("Salame",18.00,30,5);
insert tb_produtos (nome, preco, qtProduto, categoria_id) values ("Medalhão",50.00,30,3);
